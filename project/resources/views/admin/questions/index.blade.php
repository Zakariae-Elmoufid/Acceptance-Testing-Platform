    ...
    <div class="bg-white shadow-md rounded-lg p-6 mb-4">
        ...
        <div class="mt-4 flex justify-end">
            ...
            <form action="{{ route('questions.destroy', $question) }}" method="POST" class="inline">
                @csrf
                <button type="submit" class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cette question ?')">
                    delete
                </button>
            </form>
        </div>
